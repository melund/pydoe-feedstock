...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3234&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydoe-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydoe` can be installed with `conda`:
...
It is possible to list all of the versions of `pydoe` available on your platform with `conda`:
...
```
mamba search pydoe --channel conda-forge
```
...
mamba repoquery search pydoe --channel conda-forge

# List packages depending on `pydoe`:
mamba repoquery whoneeds pydoe --channel conda-forge

# List dependencies of `pydoe`:
mamba repoquery depends pydoe --channel conda-forge
```
